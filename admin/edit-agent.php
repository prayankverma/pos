            ...
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    <select class="form-select" id="agent-role" name="agentrole" aria-label="Agent-Type" required="">
                        <option value="">---Select---</option>
                        <option value="Master" <?php if($getrow['userrole']=='Master'){echo 'Selected';} ?> > Master</option>
                        <option value="Individual" <?php if($getrow['userrole']=='Individual'){echo 'Selected';} ?>>Individual</option>
                    </select>
