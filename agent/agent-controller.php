...
if (isset($_POST['AddAgent'])) {
    ...
    if ($result) 
    {
        ...
        if($updateResult)
        {
            echo "<script>alert('Agent details added successfully!');</script>";
        }
        else
        {
             echo "<script>alert('Warning ! Agent details added successfully! But userid is not created. kindly connect with Admin Team.');</script>";
        }
